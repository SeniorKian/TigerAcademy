        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Quota = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_Consultations_ConsultationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Consultations_Order",
                table: "Consultations",
                column: "Order");

            migrationBuilder.CreateIndex(
                name: "IX_Contents_Key_Page_Language",
                table: "Contents",
                columns: new[] { "Key", "Page", "Language" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Contents_Page",
                table: "Contents",
                column: "Page");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FieldsOfStudy_Order",
                table: "FieldsOfStudy",
                column: "Order");

            migrationBuilder.CreateIndex(
                name: "IX_InstallationStates_Key",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Provinces_Order",
                table: "Provinces",
                column: "Order");

            migrationBuilder.CreateIndex(
                name: "IX_Quotas_Order",
                table: "Quotas",
                column: "Order");
